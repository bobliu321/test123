...
set search_path    "/CMC/setups/ensc450/SOCLAB/LIBRARIES/NangateOpenCellLibrary_PDKv1_3_v2010_12/Front_End/Verilog"
...
set target_library "NangateOpenCellLibrary.v"
...
analyze -format vhdl ../vhdl/fpu_double/fpupack.vhd
analyze -format vhdl ../vhdl/fpu_double/comppack.vhd
analyze -format vhdl ../vhdl/fpu_double/fpu_double.vhd
analyze -format vhdl ../vhdl/fpu_double/fpu_add.vhd
analyze -format vhdl ../vhdl/fpu_double/fpu_sub.vhd
analyze -format vhdl ../vhdl/fpu_double/fpu_mul.vhd
analyze -format vhdl ../vhdl/fpu_double/fpu_div.vhd
analyze -format vhdl ../vhdl/fpu_double/fpu_round.vhd
analyze -format vhdl ../vhdl/fpu_double/fpu_exceptions.vhd
